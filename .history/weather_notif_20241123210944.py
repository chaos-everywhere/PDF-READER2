...
#print(soup.prettify())
    ...
    try:
        temp = soup.find("span", class_="_-_-components-src-organism-CurrentConditions-CurrentConditions--tempValue--zUBSz")
...
if __name__ == "__main__":
    weather_url = "https://weather.com/en-IN/weather/today/l/25.59,85.14?par=google&temp=c/"
